'''1. translate image piexls into haar-like features
   2. use integral image to achieve fast calculation of haar-like features
   3. build an adaboost model trained by haar-like features to obtain the face-detection function'''
...
class Face_Detect(object):
    ...
    def cor_rate(self):
        ...
        for i in range(len(self.test_image_features)):
            ...
            np.append(self.test_haar_features,haarFeatures)
